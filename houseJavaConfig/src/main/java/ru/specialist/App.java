...
public class App {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context=new AnnotationConfigApplicationContext(BuilderConfig.class);
...
//Конфигурацию описать с помощью отд.класса GraphConfig.Создать новый проект и туда скопировать классы убрать аннотац.Потом делать конфишгурацию с помощью javaconfig