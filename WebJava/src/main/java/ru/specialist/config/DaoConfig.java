...
@PropertySource("/WEB-INF/jdbc.properties")//указывает из какого properties читать параметры
@ComponentScan(basePackages={"ru.specialist.dao"})//указывает в каких пакетах искать бины, отмеченные аннотацией спринга
